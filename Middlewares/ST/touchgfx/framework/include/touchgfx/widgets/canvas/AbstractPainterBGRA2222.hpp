...
/**
 * @file touchgfx/widgets/canvas/AbstractPainterBGRA2222.hpp
 *
 * Declares the touchgfx::AbstractPainterBGRA2222 class.
 */
#ifndef TOUCHGFX_ABSTRACTPAINTERBGRA2222_HPP
#define TOUCHGFX_ABSTRACTPAINTERBGRA2222_HPP
...
{
/**
 * The AbstractPainterBGRA2222 class is an abstract class for creating a painter to draw on a
 * BGRA2222 display using CanvasWidgetRenderer.
 *
 * @see AbstractPainter
 */
...
public:
    ...
    {
        return alphaBlend(LCD8bpp_BGRA2222::getRedFromNativeColor(newpix),
                          LCD8bpp_BGRA2222::getGreenFromNativeColor(newpix),
                          LCD8bpp_BGRA2222::getBlueFromNativeColor(newpix), bufpix, alpha);
    }
    ...
    FORCE_INLINE_FUNCTION uint8_t alphaBlend(uint8_t R, uint8_t G, uint8_t B, uint8_t bufpix, uint8_t alpha) const
    {
        ...
        const uint8_t p_red = LCD8bpp_BGRA2222::getRedFromNativeColor(bufpix);
        const uint8_t p_green = LCD8bpp_BGRA2222::getGreenFromNativeColor(bufpix);
        const uint8_t p_blue = LCD8bpp_BGRA2222::getBlueFromNativeColor(bufpix);
        ...
        return LCD8bpp_BGRA2222::getNativeColorFromRGB(red, green, blue);
    }
};

} // namespace touchgfx

#endif // TOUCHGFX_ABSTRACTPAINTERBGRA2222_HPP
