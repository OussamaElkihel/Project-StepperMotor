...
// Definition for Stepper_task
osThreadId_t Stepper_TaskHandle;
const osThreadAttr_t Stepper_Task_attributes = {
  .name = "Stepper_Task",
  .stack_size = 128 * 4,
...
extern void Stepper_Task(void *argument); //stepper task defined in stepper_user.c
...
float shared_angle = 0.0;
int shared_motor_stopped = 0;
int shared_mode = 0;
int shared_speed = 0;
...
int main(void)
{
  ...
  // creation of Stepper_Task
  Stepper_TaskHandle = osThreadNew(Stepper_Task, NULL, &Stepper_Task_attributes);
