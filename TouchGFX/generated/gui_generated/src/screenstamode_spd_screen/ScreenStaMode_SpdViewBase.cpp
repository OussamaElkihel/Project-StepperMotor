    ...
    buttonCallback(this, &ScreenStaMode_SpdViewBase::buttonCallbackHandler)
{
    ...
    buttonDelete.setLabelText(touchgfx::TypedText(T___SINGLEUSE_GTX4));
    ...
    buttonKey3.setLabelText(touchgfx::TypedText(T___SINGLEUSE_2T3Y));
    ...
    Unicode::snprintf(textArea1Buffer, TEXTAREA1_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_JGIA).getText());
    textArea1.setWildcard(textArea1Buffer);
    textArea1.resizeToCurrentText();
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_UTCX));
    add(textArea1);

    textArea2.setXY(44, 33);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_MZ3Q));
    add(textArea2);
    ...
    buttonKey1.setLabelText(touchgfx::TypedText(T___SINGLEUSE_JRJE));
    ...
    buttonKey0.setLabelText(touchgfx::TypedText(T___SINGLEUSE_JF7K));
    ...
    buttonKey2.setLabelText(touchgfx::TypedText(T___SINGLEUSE_TKUV));
    ...
    buttonKeyComma.setLabelText(touchgfx::TypedText(T___SINGLEUSE_ZVHX));
    ...
    buttonKey4.setLabelText(touchgfx::TypedText(T___SINGLEUSE_180D));
    ...
    buttonKey5.setLabelText(touchgfx::TypedText(T___SINGLEUSE_P9JE));
    ...
    buttonKey6.setLabelText(touchgfx::TypedText(T___SINGLEUSE_UUB3));
    ...
    buttonKey7.setLabelText(touchgfx::TypedText(T___SINGLEUSE_JPL9));
    ...
    buttonKey8.setLabelText(touchgfx::TypedText(T___SINGLEUSE_RBBZ));
    ...
    buttonKey9.setLabelText(touchgfx::TypedText(T___SINGLEUSE_9CM3));
    ...
    Unicode::snprintf(textArea3Buffer, TEXTAREA3_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_G659).getText());
    textArea3.setWildcard(textArea3Buffer);
    textArea3.resizeToCurrentText();
    textArea3.setTypedText(touchgfx::TypedText(T___SINGLEUSE_AWAD));
    add(textArea3);
}
...
void ScreenStaMode_SpdViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    if (&src == &buttonValidate)
    {
        ...
        //Interaction1
        //When InteractionValidate completed change screen to ScreenStaControl
        //Go to ScreenStaControl with screen transition towards East
        application().gotoScreenStaControlScreenSlideTransitionEast();
    }
    if (&src == &buttonKey1)
    {
        //InteractionKey1
